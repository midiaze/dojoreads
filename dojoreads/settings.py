...
SECRET_KEY = '&_eq=5kb%%wf$hw2dgtn2k)4kqe5#%xrw$lfg@jj7ku+00y8=u'
...
DATABASES = {
    'default': {
       'ENGINE': 'django.db.backends.postgresql', # cambiar la base de datos a postgres
        'NAME': 'dojoreads', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
